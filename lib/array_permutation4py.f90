...
end subroutine Array_Permutation_fort_complex 
...
!!!!!!!!!!!!!!!!!!! 下面测试的几个版本是 Array_Permutation !本身不并行，而把外层player 并行，这样应该更快。!!!!!!
...
!$OMP END do 
!$OMP END PARALLEL
end subroutine complex_permute_player_fort_parallel_dynamic
